This is a simple Hangman game written in Java using JavaFX for the graphical user interface. The goal of the game is to guess the word before running out of attempts.
